package com.realityexpander.tictactoe
...
fun TicTacToe(
    ...
    // Get a coroutine scope for the animations
...
private fun CoroutineScope.animateFloatToOne(animatable: Animatable<Float, AnimationVector1D>) {
    ...
    // Coroutine scope is required to run the animation.
    this.launch {
